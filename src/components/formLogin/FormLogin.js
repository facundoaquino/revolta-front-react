    ...
    return (
        <div className='form_container'>
            ...
            <form onSubmit={handlerSubmit} className='form_form' action="">
                <label className='form_label' htmlFor="user">Usuario</label>
                ...
                <input onChange={handlerChange} id='password' className='form_input' type="password" name='password' required />
